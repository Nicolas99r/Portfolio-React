...
import HeroImg from '../assets/nick5.jpg';
        ...
        <div className='hero'>
            <div className='container'>
                <h1 className='hero__heading'>
                    ...
                    <span className='hero__name'>Nicolás Reyes</span>
                </h1>
                <div className='hero__img'>
                    <img src={HeroImg} alt=""></img>
                </div>
                <div className='hero__info'>
                    <PText>Multimedia Engineer</PText>
                    <PText>Like a normal Engineer... but better</PText>
                    <Button 
                        btnLink="/projects" 
                        btnText='See my work'
                        outline={false}>
                ...
                <div className='hero__social'>
                    ...
                    <div className='hero__social__text'>
                        <ul>
                            ...
                            <li>
                                <a href='https://www.google.com.co/' target="_blank" rel='noreferrer'>LI</a>
                            </li>
                        </ul>
                    </div>
                </div>
